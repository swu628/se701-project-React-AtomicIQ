...
import NotImplementedDialog from "~/components/NotImplementedDialog.tsx";
...
export default function Results() {
    ...
    return (
        <Box display="flex" mt="7.5vh" justifyContent="center">
            <Paper elevation={3} sx={{width: "80vw", minHeight: "75vh", p: "2rem"}}>
                ...
                >
                    ...
                    <Stack direction="row" justifyContent="space-between">
                        ...
                        <Button variant="contained" startIcon={<PreviewIcon/>} onClick={handleClickOpen}>
                            Review Quiz
                        </Button>
                        <Button
                            variant="contained"
            ...
            <NotImplementedDialog open={open} handleClose={handleClose}/>
        </Box>
    );
}
