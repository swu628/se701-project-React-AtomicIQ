       ...
       <div className="relative z-10 flex flex-col items-center justify-center h-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
         <div className="lg:w-1/2">
           ...
           <p className="mt-4 max-w-2xl text-xl text-indigo-100">
             Explore interactive activities and virtual experiments to discover the fascinating world of chemistry!
           </p>
         </div>
            ...
            <Link to="/solids-liquids-gases">
              <div className="flex items-center justify-between space-x-4 bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition-colors">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <span className="font-semibold">1.1 Solids, Liquids, and Gases</span>
                    <Progress value={75} className="w-48 h-6 mt-2">75%</Progress>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between space-x-4 bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition-colors">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <Progress value={25} className="w-48 h-6 mt-2">25%</Progress>
                  </div>
                </div>
                <Button variant="outline">Go to Activity</Button>
              </div>
            ...
            <Link to="/elements-compounds-mixtures">
              <div className="flex items-center justify-between space-x-4 bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition-colors">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <span className="font-semibold">2.1 Elements, Compounds, and Mixtures</span>
                    <Progress value={50} className="w-48 h-6 mt-2">50%</Progress>
                  </div>
                </div>
                <Button variant="outline">Go to Activity</Button>
              </div>
            ...
            <Link to="/atomic-structure">
              <div className="flex items-center justify-between space-x-4 bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition-colors">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <span className="font-semibold">2.2 Atomic Structure and the Periodic Table</span>
                    <Progress value={75} className="w-48 h-6 mt-2">75%</Progress>
                  </div>
                </div>
                <Button variant="outline">Go to Activity</Button>
              ...
              <div className="flex items-center justify-between space-x-4 bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition-colors">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <Progress value={0} className="w-48 h-6 mt-2">0%</Progress>
                  </div>
                </div>
                <Button variant="outline">Go to Activity</Button>
              </div>
            ...
            <Link to="/ionic-bonds">
              <div className="flex items-center justify-between space-x-4 bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition-colors">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <span className="font-semibold">2.4 Ions and Ionic Bonds</span>
                    <Progress value={100} className="w-48 h-6 mt-2">100%</Progress>
                  </div>
                </div>
                <Button variant="outline">Go to Activity</Button>
              </div>
            ...
            <Link to="/covalent-bonds">
              <div className="flex items-center justify-between space-x-4 bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition-colors">
                <div className="flex items-center space-x-4">
                  <FontAwesomeIcon icon={faMicroscope} size="2x" />
                  <div>
                    <span className="font-semibold">2.5 Simple Molecules and Covalent Bonds</span>
                    <Progress value={25} className="w-48 h-6 mt-2">25%</Progress>
                  </div>
                </div>
                <Button variant="outline">Go to Activity</Button>
            ...
            <Link to="/giant-covalent">
              <div className="flex items-center justify-between space-x-4 bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition-colors">
                <div className="flex items-center space-x-4">
                  <FontAwesomeIcon icon={faShapes} size="2x" />
                  <div>
                    <span className="font-semibold">2.6 Giant Covalent Structures</span>
                    <Progress value={50} className="w-48 h-6 mt-2">50%</Progress>
                  </div>
                </div>
                <Button variant="outline">Go to Activity</Button>
