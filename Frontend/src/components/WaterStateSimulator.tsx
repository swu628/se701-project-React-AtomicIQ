...
let questions = [
  {
    ...
    options: [
      {
        value: "option1",
        text: "Particles are close together but can move past each other freely.",
        feedback: "This description fits a liquid state.",
      },
      {
        value: "option2",
        text: "Particles are packed closely together in a fixed, orderly pattern.",
        feedback: "This description fits a solid state.",
      },
      {
        value: "option3",
        text: "Particles are far apart and move independently of each other.",
        feedback: "This description fits a gas state.",
      },
      {
        value: "option4",
        text: "Particles are in a fixed position but can easily slide past each other.",
        feedback:
          "This description does not accurately represent any of the states of matter.",
      },
    ],
