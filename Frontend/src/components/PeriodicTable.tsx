...
const PeriodicTable = () => {
    ...
    const maxPeriod = Math.max(...Elements.map((element: ElementData) => element.period));
    const maxGroup = Math.max(...Elements.map((element: ElementData) => element.group));
                        ...
                        <TableRow key={`period-${period + 1}`}>
                            ...
                            {Array.from({length: maxGroup}, (_, group) => {
                                const element = Elements.find(
                                    (el: ElementData) => el.period === period + 1 && el.group === group + 1
                                );
                                ...
                                return (
                                    <TableCell
                                        ...
                                        onClick={() => element && handleCellClick(element)}
                                    >
